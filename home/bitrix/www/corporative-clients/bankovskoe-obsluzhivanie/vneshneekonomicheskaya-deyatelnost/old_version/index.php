...
<div class="v21-section">
    <? $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "AJAX_OPTION_JUMP" => "N",
            "AJAX_OPTION_STYLE" => "Y",
            "IBLOCK_ID" => "203",  // Заявка на валютный счёт
            "PROPERTIES" => array("COMPANY", "PHONE", "EMAIL", "CITY", "FIO"),
            "SITES" => array("s1"),
        )
    ); ?>
</div>
<div class="v21-section v21-section-ved-documents">
    <? $APPLICATION->IncludeComponent(
        "bitrix:news.list",
        "v21_safes_docs",
        array(
