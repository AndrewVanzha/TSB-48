...
<? if ($arResult['PROPERTIES']['ATT_PICTURES']['VALUE'] !== false) { ?>
    <div class="photo-slider">

        <div class="owl-carousel">

            <? foreach ($arResult['PROPERTIES']['ATT_PICTURES']['VALUE'] as $picture) { ?>
                <? $arFile = CFile::GetFileArray($picture); ?>
                <a href="<?= $arFile['SRC'] ?>" data-fancybox="gallery" data-caption="<?= $arFile['DESCRIPTION'] ?>" class="slide">
