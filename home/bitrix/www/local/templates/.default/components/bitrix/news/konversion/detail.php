...
?>
<?
$type_id = trim(htmlspecialchars($_GET['q']));
...
$typeString = '';
if ($arTypes[$type_id]) {
    $typeString = $arTypes[$type_id]['PROPERTY_ADD_BLOCK_HEADER_VALUE'];
}
?>
<?/*?><h1 class="v21-h1-new v21-konversion--header">Конверсионные сделки</h1><?*/?>
...
<div class="v21-konversion-application" id="fKonversionForm">
    <?$APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "IBLOCK_ID" => "216",  // Заявка на конверсионные операции
