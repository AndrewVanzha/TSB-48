...
//file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/chastnym-klientam/a_fields.json', json_encode($fields));
...
$elementFields['FORM'] = 136;  //  Согласие на новые тарифы: администратор

$success_message = 'Сообщение успешно отправлено';
if ($elementFields["PROPERTY_VALUES"][799] == 'не принимаю') {
