...
<script type="text/javascript">
    $(document).ready(function() {
        $('input[name=NAME]').val($('input[name=ORGANIZATION]').val()); // пишу в input[name=NAME] исходное значение из input[name=COMPANY_NAME]
        ...
        function changeColors(scrollTop) {
            ...
            let fixLevel1 = formBlockTop - windowInnerWidth * .20; // уровень первого переключения
            ...
            if(scrollTop > fixLevel2) {
                ...
                $('.corpcards-page__background-blue').css('opacity', '0');
                $('.v21 .v21-card-application').removeClass('js-color-switch');
                $('.v21 .v21-block-advantages').removeClass('js-color-switch');
                $('.v21 .v21-block-interests').removeClass('js-color-switch');
            } else if(scrollTop > fixLevel1) {
                $('.corpcards-page__background-blue').css('opacity', '1');
                $('.v21 .v21-card-application').addClass('js-color-switch');
                $('.v21 .v21-block-advantages').addClass('js-color-switch');
