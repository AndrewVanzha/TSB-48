...
class inkass_service extends CModule
{
    public function __construct()
    {
        if (file_exists(__DIR__ . "/version.php")) {
            ...
            $this->MODULE_NAME = Loc::getMessage("S_INKASS_NAME");
            $this->MODULE_DESCRIPTION = Loc::getMessage("S_INKASS_DESCRIPTION");
            $this->PARTNER_NAME = Loc::getMessage("S_INKASS_PARTNER_NAME");
            $this->PARTNER_URI = Loc::getMessage("S_INKASS_PARTNER_URI");
        }
    ...
    public function DoInstall()
    {
        ...
        if (CheckVersion(ModuleManager::getVersion("main"), "14.00.00")) {
            ...
            $APPLICATION->ThrowException(
                Loc::getMessage("S_INKASS_INSTALL_ERROR_VERSION")
            );
        }

        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("S_INKASS_INSTALL_TITLE") . " \"" . Loc::getMessage("FALBAR_TOTOP_NAME") . "\"",
            __DIR__ . "/step.php"
        );
    ...
    {
        //debugg(Application::getDocumentRoot() . "/" . $this->MODULE_ID . "/");
        //file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/logs/a_inkass_UnInstallFiles.json', json_encode([Application::getDocumentRoot() . "/" . $this->MODULE_ID . "/"]));
