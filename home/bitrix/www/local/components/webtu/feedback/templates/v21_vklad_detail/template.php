...
<form action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST" id="depositOrder" class="v21-service-form v21-service-form--bg v21-section">
    ...
    <div class="v21-service-form__content">
        <h2 class="v21-service-form__title v21-h2"><?= GetMessage("WEBTU_FEEDBACK_8_HEADER") ?></h2>
        ...
        $('#depositOrder').submit(function (e) {
            ...
            if ($("#politics").prop("checked")) {
                ...
                if (requiredFields()) {
                    $.ajax({
                        type: "POST",
                        url: '/local/components/webtu/feedback/templates/v21_vklad_detail/ajax.customer.php',
                        data: {
