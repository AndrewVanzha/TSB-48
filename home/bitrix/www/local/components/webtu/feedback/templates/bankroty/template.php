...
<form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
	...
	<div class="oosb-form__row">
		<input required type="text" name="NAME" class="oosb-form__input" placeholder="<?=GetMessage("WEBTU_FEEDBACK_9_NAME")?>">
	</div>
	
	<div class="oosb-form__row">
		<input required type="tel" name="PHONE" class="oosb-form__input" data-mask="phone" placeholder="+7 (___) ___-__-__">
	</div>
	
	<div class="oosb-form__row">
		<input type="email" name="EMAIL" class="oosb-form__input" placeholder="example@site.ru">
	</div>

    <div class="oosb-form__row">
        <input required type="text" name="FROM_WHERE" class="oosb-form__input" placeholder="Откуда Вы узнали о нас">
    </div>
	...
	<div class="oosb-form__row policy">
		<input type="checkbox" id="oosb-policy" checked required>
		<label for="oosb-policy" class="oosb-form__policy"><?=$politics_output?></label>
	</div>
	
	<div class="oosb-form__row captcha clearfix">
	...
	<div class="oosb-form__row">
		<button class="oosb-form__button" name="WEBTU_FEEDBACK"><?=GetMessage("WEBTU_FEEDBACK_9_BUTTON")?></button>
	</div>
...
<script>
    ...
    $('.oosb-form__wrapper .oosb-form__button').click(function () {
        $(".alert").remove();
    });
