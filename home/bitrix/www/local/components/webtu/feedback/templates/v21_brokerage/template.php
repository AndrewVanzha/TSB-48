...
<div data-overlay="v21_overlay" class="v21-modal v21-fade js-v21-modal" id="v21_brokerageOrder">
    <div class="v21-modal__window js-v21-modal-window">
        <a href="#v21_brokerageOrder" class="v21-modal__close js-v21-modal-toggle">
        ...
        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST" class="v21-service-form" id="brokerageOrder">
            ...
            <div class="v21-service-form__section">
                ...
                <div class="v21-grid">
                    ...
                    <div class="v21-grid__item v21-grid__item--1x2@sm v21-grid__item--1x2@lg">
                        <label class="v21-input-group">
                    ...
                    <div class="v21-grid__item v21-grid__item--1x2@sm v21-grid__item--1x3@lg" style="display:none;">
                        <label class="v21-input-group">
                    ...
                    <div class="v21-grid__item v21-grid__item--1x2@sm v21-grid__item--1x2@lg">
                        <label class="v21-input-group">
                            ...
                            <span class="v21-input-group__warn">Обязательное поле к заполнению1</span>
            ...
            <div class="v21-service-form__section">
                ...
                <div class="v21-grid">
                    ...
                    <div class="v21-grid__item">
                        ...
                        $politics_1 = "<a href='/assets/docs/Правила_оформления_онлайн_заявок.pdf' target='_blank' class='v21-link'><span class='v21-link__text'>" . GetMessage("WEBTU_FEEDBACK_8_POLITICS_1") . "</span></a>";
                        $politics_2 = "<a href='/assets/docs/Согласие_на_обработку_ПД_для_сайта.pdf' target='_blank' class='v21-link'><span class='v21-link__text'>" . GetMessage("WEBTU_FEEDBACK_8_POLITICS_2") . "</span></a>";
...
<div data-overlay="v21_overlay" class="v21-modal v21-fade js-v21-modal" id="v21_alert_brokerageOrder">
    <div class="v21-modal__window js-v21-modal-window">
        <a href="#v21_alert_brokerageOrder" class="v21-modal__close js-v21-modal-toggle">
            <svg width="24" height="24">
                <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/v21_v21-icons.svg#close"></use>
            </svg>
        </a>
