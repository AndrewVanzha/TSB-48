...
<div data-overlay="v21_overlay" class="v21-modal v21-fade js-v21-modal" id="v21_mortgageOrder">
    <div class="v21-modal__window js-v21-modal-window">
        <a href="#v21_mortgageOrder" class="v21-modal__close js-v21-modal-toggle">
        ...
        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST" class="v21-service-form" id="mortgageOrder">
...
<div data-overlay="v21_overlay" class="v21-modal v21-fade js-v21-modal" id="v21_alert_mortgageOrder">
    <div class="v21-modal__window js-v21-modal-window">
        <a href="#v21_alert_mortgageOrder" class="v21-modal__close js-v21-modal-toggle">
            <svg width="24" height="24">
                <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/v21_v21-icons.svg#close"></use>
            </svg>
        </a>
